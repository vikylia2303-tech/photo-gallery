      ...
      <section className="py-20 border-t border-gray-100">
        <div className="container-narrow text-center">
          ...
          <div className="space-y-6 text-[17px] leading-relaxed text-gray-600 text-left">
            <p>
              Когда-то фотография была просто увлечением, а теперь это любимое хобби,
              от которого я по-настоящему кайфую. Снимаю на Canon R8.
            </p>
            <p>
              Люблю живой свет, настоящие эмоции и кадры, в которых человек остаётся собой.
              Ниже — мои фотосессии: загляните и почувствуйте настроение.
            </p>
          </div>
        </div>
      </section>
