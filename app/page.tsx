    ...
    <div>
      ...
      <section className="py-20 border-t border-gray-100">
        <div className="container-narrow text-center">
          ...
          <h2 className="section-title text-4xl md:text-5xl mb-10">Фотография для меня</h2>
          <div className="space-y-6 text-[17px] leading-relaxed text-gray-600 text-left">
            <p>
              Фотографией я занималась ещё в детстве, а будучи студенткой мечтала о том, что буду
              снимать. Был период, когда я фотографировала, а потом забросила.
            </p>
            <p>
              В 2025 году я вернулась и воплотила мечту по полной — купила камеру, о которой так
              мечтала. Снимаю на Canon R8.
            </p>
            <p>
              Теперь у моих близких всегда есть классные кадры на память, а для любимых подруг я
              с радостью выступлю в роли фотографа и проведу классную съёмку.
            </p>
          </div>
        </div>
      </section>
