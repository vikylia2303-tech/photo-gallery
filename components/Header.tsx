      ...
      <div className="container">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4 text-gray-500">
            <a href="https://vk.com/nikatarova" aria-label="VK" className="hover:text-black transition" target="_blank" rel="noreferrer">
            ...
            <a href="https://t.me/viktoriia_taranova" aria-label="Telegram" className="hover:text-black transition" target="_blank" rel="noreferrer">
            ...
            <a href="https://instagram.com/nikatarova" aria-label="Instagram" className="hover:text-black transition" target="_blank" rel="noreferrer">
