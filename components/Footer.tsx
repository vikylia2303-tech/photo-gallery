    ...
    <footer id="contact" className="border-t border-gray-100 py-20 text-center">
      <div className="container-narrow">
        ...
        <div className="space-y-2 text-gray-600 text-[15px]">
          <p>
            <a href="mailto:hello@example.com" className="hover:text-black transition">hello@example.com</a>
          </p>
          <p>
            <a href="tel:+79990000000" className="hover:text-black transition">+7 (999) 000-00-00</a>
          </p>
          <p>Волгоград · Москва · Санкт-Петербург</p>
        </div>

        <div className="flex items-center justify-center gap-6 mt-10 text-gray-500">
          <a href="https://vk.com" className="hover:text-black transition" target="_blank" rel="noreferrer">
          ...
          <a href="https://t.me" className="hover:text-black transition" target="_blank" rel="noreferrer">
          ...
          <a href="https://instagram.com" className="hover:text-black transition" target="_blank" rel="noreferrer">
